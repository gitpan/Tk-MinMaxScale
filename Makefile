...
FULLEXT = Tk/MinMaxScale
BASEEXT = MinMaxScale
PARENT_NAME = Tk
DLBASE = $(BASEEXT)
VERSION_FROM = MinMaxScale.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/MinMaxScale.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Tk-MinMaxScale\" VERSION=\"0,08,0,0\">\n}. qq{\t<TITLE>Tk-MinMaxScale</TITLE>\n}. qq{\t<ABSTRACT>Two Scale(s) to get a (min, max) values pair</ABSTRACT>\n}. qq{\t<AUTHOR>Jean-Pierre Vidal &lt;jpvidal\@cpan.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Tk-MinMaxScale.ppd
